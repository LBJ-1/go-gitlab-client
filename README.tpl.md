...
```
go get github.com/LBJ-1/go-gitlab-client/gitlab
```
...
To update `go-gitlab-client`, use `go get -u`:
    ...
    go get -u github.com/LBJ-1/go-gitlab-client/gitlab

### Documentation

Visit the docs at http://godoc.org/github.com/LBJ-1/go-gitlab-client/gitlab
...
Go to the [releases page](https://github.com/LBJ-1/go-gitlab-client/releases),
